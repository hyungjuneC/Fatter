...
import javax.swing.border.EmptyBorder;
	 ...
	 public TestLayOut6(int hour, int minute, int second,int remain){
	  ...
	  chetView.setText("Last eaten Time:"+String.valueOf(hour)+":"+String.valueOf(minute)+":"+String.valueOf(second)+"\nRemain Time until Alarm:"+String.valueOf(remain));
	  chetView.setFont(chetView.getFont().deriveFont(16f));
...
public class Time  extends Thread{
	...
	public void getEatenTime() {
		new TestLayOut6(this.hour,this.minute,this.second,this.remaintime);
	}
	public int getHour() {
		return this.hour;
	}
